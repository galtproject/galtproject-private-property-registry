...
describe('Mediators', () => {
  ...
  describe('ForeignMediator', () => {
    ...
    it('#handleBridgedTokens()', async function() {
      ...
      const data = foreignMediator.contract.methods.handleBridgedTokens(bob, token1, nonce).encodeABI();
    ...
    describe('#fixFailedMewsage() foreign -> home transfer', () => {
      ...
      it('should allow fixing locked tokens on foreign chain', async function() {
        ...
        const fixData = foreignMediator.contract.methods.fixFailedMessage(dataHash).encodeABI();
  ...
  describe('HomeMediator', () => {
    ...
    it('#handleBridgedTokens() should mint a new token', async function() {
      ...
      const data = homeMediator.contract.methods.handleBridgedTokens(bob, token1, bridgedData, nonce).encodeABI();
    ...
    it('#handleBurnedToken() should allow anyone sending sync tx to a home chain', async function() {
      let data = homeMediator.contract.methods.handleBridgedTokens(bob, token1, bridgedData, nonce).encodeABI();
      ...
      data = homeMediator.contract.methods.handleBurnedToken(token1).encodeABI();
    ...
    it('#fixFailedMessage() should allow fixing a transfer on home network', async function() {
      ...
      const fixData = homeMediator.contract.methods.fixFailedMessage(dataHash).encodeABI();
